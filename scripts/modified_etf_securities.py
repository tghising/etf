...
def get_all_products(base_url, product_url):
    ...
    remove_cols = [x for x in headings if "Sort:" in x or x == "" or x == None] # list columns that contains Sort: in name or None or ""
...
COL_DISPLAY = ['Issuer','etf ticker','Security Ticker','Country Code','Security Name','Weight %','Market Value', 'Rate','Maturity date','Sector','Country']
